...
namespace Microsoft.Samples.Kinect.HDFaceBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged, IDisposable
    {
        ...
        BiometricData Majid;
        BiometricData UnknownSubj;
        public List<BiometricData> Record;
        ...
        public MainWindow()
        {
            ...
            UnknownSubj.SpeedOfBlinks = new List<List<List<double>>>();
            UnknownSubj.AccelOfBlinks = new List<List<List<double>>>();
            UnknownSubj.Name = "Unknown";
            UnknownSubj.TestSubject = 2;
            InitializeRecord();
        }
